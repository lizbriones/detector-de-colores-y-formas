# incluyendo las librerías a emplear
import cv2
...
def draw(mask, color):
    ...
    for c in contornos:
        ...
        if area > 1000:
        #buscar el punto central del objeto identificado 
            M = cv2.moments(c)
            if (M["m00"] == 0):
                M["m00"] = 1
